def extract_fp_daq_split(ses, save=True, correct_bleaching=True, framerate=50, split = 620000, after_split= False):
    '''
    Extracts sessions where there is a single FP recording for several FP sessions
    split points
    /Volumes/witten/Alex/Data/Subjects/fip_34/2022-12-07(bpod_data divided in 2)/001 = 620000
    /Volumes/witten/Alex/Data/Subjects/fip_34/2022-12-14(bpod_data divided in 2) = 1814980
    ...
    if after_split == False:
        ...
        signal['DAQ_bpod']= 0
        signal['DAQ_bpod'][:split] = tdms_file._channel_data["/'Analog'/'AI1'"].data[:split]
